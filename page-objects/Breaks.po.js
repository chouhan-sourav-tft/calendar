/*global browser, secondContext, secondSession, thirdContext, thirdSession*/
...
exports.Breaks = class Breaks extends BaseAction {
  ...
  elements = {
    ...
    authTrue: '.new-break i[data-name="agent_permission"]',
  ...
  async exceedTimeValidate(breakName) {
    ...
    const locatorOnAction = `//a[contains(@class, "bg-color-red break-active") and contains(., "${breakName}")]`;
